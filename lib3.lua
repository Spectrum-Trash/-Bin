...
local ClosureBindings = {
    function()local maui,script,require,getfenv,setfenv=ImportGlobals(1)local Library = {
    isValidated = false
}

local UIInitilize = require(script.Window)
...
function Library.Init()
    if KeyManager:CheckKey() then
        ...
        repeat
            wait()
        until Library.isValidated
        return Library.isValidated
    end
end

return Library -- Ensure you return the table here
 end,
    function()local maui,script,require,getfenv,setfenv=ImportGlobals(2)local Module = {}
...
if shared.MainUII ~= nil then
	shared.MainUII:Destroy()
end
...
function Module:InitUI()
	...
	-- AcrylicPaint.AddParent(WindowFrame)
	...
	local KeyTextBox = Create("TextBox", {
		...
		PlaceholderText = "Place here key",
		Text = "",
		TextColor3 = Color3.fromRGB(232, 227, 247),
		TextSize = 14,
		TextXAlignment = Enum.TextXAlignment.Left,
	...
	AddSignal(CheckKey.MouseButton1Click, function()
        ...
        if self.Library.isValidated then
...
return Module
    ...
    [4] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(4)local Acrylic = {
...
return Acrylic
    ...
    [5] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(5)local Creator = require(script.Parent.Parent.Creator)
...
return function(distance)
    ...
    [6] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(6)local Creator = require(script.Parent.Parent.Creator)
...
return createAcrylic
    ...
    [8] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(8)local function map(value, inMin, inMax, outMin, outMax)
...
return { viewportPointToWorld, getOffset }
    ...
    [9] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(9)local Root = script.Parent
...
return Creator end,
    [10] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(10)local Flipper = {
...
return Flipper
    ...
    [11] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(11)local RunService = game:GetService("RunService")
...
return BaseMotor
    ...
    [12] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(12)return function()
	local RunService = game:GetService("RunService")
    ...
    [13] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(13)local BaseMotor = require(script.Parent.BaseMotor)
...
return GroupMotor
    ...
    [14] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(14)return function()
    ...
    [15] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(15)local Instant = {}
...
return Instant
    ...
    [16] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(16)return function()
	local Instant = require(script.Parent.Instant)
    ...
    [17] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(17)local Linear = {}
...
return Linear
    ...
    [18] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(18)return function()
	local SingleMotor = require(script.Parent.SingleMotor)
    ...
    [19] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(19)local Connection = {}
...
return Signal
    ...
    [20] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(20)return function()
	local Signal = require(script.Parent.Signal)
    ...
    [21] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(21)local BaseMotor = require(script.Parent.BaseMotor)
...
return SingleMotor
    ...
    [22] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(22)return function()
	local SingleMotor = require(script.Parent.SingleMotor)
	local Instant = require(script.Parent.Instant)
    ...
    [23] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(23)local VELOCITY_THRESHOLD = 0.001
...
return Spring
    ...
    [24] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(24)return function()
	local SingleMotor = require(script.Parent.SingleMotor)
	local Spring = require(script.Parent.Spring)
    ...
    [25] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(25)local function isMotor(value)
...
return isMotor
    ...
    [26] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(26)return function()
	local isMotor = require(script.Parent.isMotor)
    ...
    [28] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(28)local HttpService = cloneref(game:GetService("HttpService"))
...
return KeyManager
    ...
    [30] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(30)return {
